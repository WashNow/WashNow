                ...
                <div className={styles.paymentCard}>
                    ...
                    <div className={styles.paymentMethods}>
                        ...
                        <label className={styles.paymentOption}>
                            <input type="radio" name="payment" value="Cartão de Crédito" onChange={() => setPaymentMethod('Cartão de Crédito')} />
                            Cartão de Crédito
                        </label>
                        <label className={styles.paymentOption}>
                            <input type="radio" name="payment" value="MB Way" onChange={() => setPaymentMethod('MB Way')} />
                            MB Way
                        </label>
                        <label className={styles.paymentOption}>
                            <input type="radio" name="payment" value="Dinheiro" onChange={() => setPaymentMethod('Dinheiro')} />
                            Dinheiro
                        </label>
                    </div>
